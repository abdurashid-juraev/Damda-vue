        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div>
              ...
              <ul class="footer-sm-collapse">
                ...
                <li class="footer-tel-icon">
                  <a href="tel">+998 97 100 80 40</a>
                </li>
                <li class="footer-mail-icon"><a href="#!">info@damda.uz</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-2">
            <div>
              ...
              <ul class="footer-sm-collapse">
                ...
                <li><a href="#!">Для зон отдыха</a></li>
                <li><a href="#!">Для санаториев</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-2">
          ...
          <div class="col-md-12">
            ...
            <div class="footer-end">
              © 2021 test-site.uz All rights reserved
            </div>
          </div>
        </div>
      </div>
